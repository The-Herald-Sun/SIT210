...
// MQTT broker details (replace with your SSL-enabled broker details)
#define MQTT_SERVER "484e831498dc44a1a9ba35c92a683dca.s1.eu.hivemq.cloud"
#define MQTT_PORT 8883                       // Default MQTT over TLS/SSL port
#define MQTT_CLIENT_ID "arduinoClient-RFID-Feeder" // Unique client ID
